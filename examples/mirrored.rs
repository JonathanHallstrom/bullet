use acyclib::trainer::Trainer;
use bullet_cuda_backend::cudarc::cublaslt::Activation;
use bullet_lib::{
...
fn main() {
    ...
    let data_loader = loader::ViriBinpackLoader::new(
        ...
        Filter {
            ...
            max_eval_incorrectness: u32::max_value(),
        },
    );
