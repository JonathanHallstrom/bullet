...
use bullet_trainer::{
    model::{ModelEvaluator, ModelWeights, SavedFormat},
    optimiser::{
        Optimiser,
...
const Q1: i16 = 128;
const Q: i16 = 64;
const INPUT_BUCKETS: usize = get_num_buckets(&net::BUCKET_LAYOUT);
...
fn main() {
    let (inputs, pp, psqt, output_buckets, defn) = net::build();
